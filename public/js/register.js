...
function checkConfirmPassword(event) {
    const confirmPasswordInput = document.querySelector('.password_confirmation input');
    if (formStatus.confirmPassord = confirmPasswordInput.value === document.querySelector('.password input').value) {
        document.querySelector('.password_confirmation').classList.remove('errorj');
    } else {
        document.querySelector('.password_confirmation').classList.add('errorj');
    }
    checkForm();
}
...
document.querySelector('.password_confirmation input').addEventListener('blur', checkConfirmPassword);
